    ...
    <body>
        ...
        <div class="container container-content">
            <div class="content">
                ...
                <% } %>
                <form action="EditStudentServlet" method="post" class="form" style="grid-template-columns: auto auto;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="username" class="input" name="username" required placeholder="Enter your username..." value="<%= student.getUsername() %>">
                    </div>
                    <div class="form-group">
                        <label for="password">Password</label>
                        <input type="password" id="password" class="input" name="password" required placeholder="Enter new password...">
                    </div>
                    <div class="form-group">
                        <label for="gpa">GPA</label>
                        <input type="text" id="gpa" class="input" name="gpa" required placeholder="Enter your gpa..." value="<%= String.format("%.2f", student.getGpa()) %>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="button-group" style="grid-column: 1/3;">
                        ...
                        <a href="AllStudentServlet" class="button-secondary" style="width: 100%; text-align: center;">Cancel Edit</a>
                    </div>
                </form>
            </div>
        </div>
